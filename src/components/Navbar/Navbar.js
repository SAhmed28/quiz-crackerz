...
const Navbar = () => {
    return (
        <nav className='md:flex md:justify-between md:items-center md:m-4 md:p-4 text-center'>
            <div className="title">
                <h1 className='font-bold md:text-3xl text-2xl text-blue-700'><span className='font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-600'>Quizio</span> - An Online Learning Platform</h1>
            </div>
